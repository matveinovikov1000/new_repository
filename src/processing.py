...
def list_clean(entry_list: Iterable, mean_state="EXECUTED") -> Iterable:
    """Функция, принимающая на вход список словарей, возвращающая список словарей, у которых ключ содержит переданное в функцию значение"""
    exit_list = []
...
def list_sort(entry_list_sort: Iterable, reverse_list=True) -> Iterable:
